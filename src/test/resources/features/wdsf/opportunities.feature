...
Feature: Opportunity Creation in Salesforce
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for Sustainability Consulting record type
    ...
    When I fill in the following opportunity details:
      | Name                | Account Name | Opportunity Region | Close Date | Country       | Opportunity Currency | Opportunity Division | Primary Vertical |
      | Test SC Opportunity |              | Americas           |            | United States | USD - U.S. Dollar    | Healthcare           | Technology       |
    ...
    When I click on Opportunity Pursuit type and verify "<Opportunity pursuit type>" picklist value is displayed
    Then I select "<Opportunity pursuit type>" picklist value and Click on save
    Examples:
      | Username             | Opportunity Record Type   | Account Record Type | Search Account Name | Opportunity pursuit type |
      | TestAutomation1 jllt | Sustainability Consulting | Account Request     | Test Account        | Renewal - Transformative |
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for Generic WorkDynamics record type using Admin credentials
    ...
    When I fill in the following opportunity details for Generic WorkDynamics Opportunity:
      | Name                  | Account Name | Opportunity Region | Close Date | Country       | Opportunity Currency | Opportunity Division | Primary Vertical | Forecast Category | Stage                 |
    ...
    Examples:
      | Username                    | Opportunity Record Type | Account Record Type   | Search Account Name | Opportunity pursuit type |
      | Generic WD Automation User6 | Generic Work Dynamics   | Work Dynamics Account | Test Account        | Renewal - Transformative |
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for Generic WorkDynamics record type
    ...
    Examples:
      | Username                    | Opportunity Record Type | Account Record Type | Search Account Name | Opportunity pursuit type |
      | Generic WD Automation User6 | Generic Work Dynamics   | Account Request     | Test Account        | Renewal - Transformative |
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for Consulting record type
    ...
    When I fill in the following opportunity details:
      | Name                        | Account Name | Opportunity Region | Close Date | Country       | Opportunity Currency | Opportunity Division | Primary Vertical |
      | Test Consulting Opportunity |              | Americas           |            | United States | USD - U.S. Dollar    | Healthcare           | Healthcare       |
    And I click the Save button
    Then I should be redirected to the opportunity landing page
    And verify Business Group and Sub Business Group values on the opportunity record page:
      | Business Group | Sub Business Group |
    ...
    Examples:
      | Username                    | Opportunity Record Type | Account Record Type | Search Account Name | Opportunity pursuit type |
      | Consulting Automation User2 | Consulting              | Account Request     | Test Account        | Renewal - Transformative |
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for Solution Development record type
    ...
    Then I should see the New Opportunity form
    When I fill in the following opportunity details:
      | Name                | Account Name | Opportunity Region | Close Date | Country       | Opportunity Currency | Opportunity Division | Primary Vertical | Regional Division |
      | Test SD Opportunity |              | Americas           |            | United States | USD - U.S. Dollar    | Healthcare           | Healthcare       | AMER Healthcare   |
    And I click the Save button
    Then I should be redirected to the opportunity landing page
    And verify Business Group and Sub Business Group values on the opportunity record page:
      | Business Group | Sub Business Group    |
    ...
    Examples:
      | Username                              | Opportunity Record Type | Account Record Type | Search Account Name | Opportunity pursuit type |
      | Solution Development Automation USer4 | Solutions Development   | Account Request     | Test Account        | Renewal - Transformative |
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for PDS record type
    ...
    Then I should see the New Opportunity form
    When I fill in the following opportunity details:
      | Name                | Account Name | Opportunity Region | Opportunity Division | Close Date | Country       | Opportunity Currency | Opportunity Source | Confidentiality | JLL Account Type | Opportunity Pursuit Type   |
      | Test SD Opportunity |              | Americas           | Healthcare           |            | United States | USD - U.S. Dollar    | Billboard          | Public          | Investor         | <Opportunity pursuit type> |
    And I click the Save button
    Then I should be redirected to the opportunity landing page
    And verify Business Group and Sub Business Group values on the opportunity record page:
      | Business Group | Sub Business Group |
    ...
    Examples:
      | Username             | Opportunity Record Type | Account Record Type | Search Account Name | Opportunity pursuit type |
      | PDS Automation User1 | PDS                     | Account Request     | Test Account        | Renewal - Transformative |
  ...
  Scenario Outline: Create a new Opportunity using New Opportunity Form for Client Growth & Technology Sales record type
    ...
    Then I should see the New Opportunity form
    When I fill in the following opportunity details:
      | Name                                | Account Name | Opportunity Region | Close Date | Country       | Opportunity Currency | Opportunity Division | Primary Vertical | Client Value & Growth Team | Client Value & Growth Sub Team | Regional Division |
      | Automation Test CGT Opportunity0619 |              | Americas           |            | United States | USD - U.S. Dollar    | Healthcare           | Healthcare       | CGT Healthcare             | CGT Healthcare                 | AMER Healthcare   |
    And I click the Save button
    Then I should be redirected to the opportunity landing page
    And verify Business Group and Sub Business Group values on the opportunity record page:
      | Business Group | Sub Business Group  |
    ...
    Examples:
      | Username             | Opportunity Record Type          | Account Record Type | Search Account Name | Opportunity pursuit type |
      | CGT Automation User3 | Client Growth & Technology Sales | Account Request     | Test Account        | Renewal - Transformative |
